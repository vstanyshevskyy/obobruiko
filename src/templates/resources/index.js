        ...
        <div className={className} id="content">
          ...
          <article className="content__article">
            ...
            { image
              ? (
                <>
                  <GatsbyImage image={image.childImageSharp.gatsbyImageData} alt={imageAlt} className="article-title__image" />
...
export const pageQuery = graphql`query resourceContentQuery($slug: String!) {
