...
const SocraticQuestioning = ({
  ...
  useEffect(() => {
    if (typeof window !== 'undefined') {
      ...
      if (saved) {
        try {
          const { thought: savedThought, answers: savedAnswers } =
            JSON.parse(saved)
  ...
  const isBookingButtonVisible =
    bookConsultationButtonText &&
    (bookConsultationButtonLinkPrivate || bookConsultationButtonLinkOpenup)
              ...
              <article className="content__page content__questionnaire">
                <div className="content__page-wrapper">
                  <div className="questionnaire">
                    ...
                    <form
                      className="socratic-questioning__form"
                    ...
                    >
                      ...
                      {questions.map((questionObj, index) => (
                        <div
                          key={index}
                          className="socratic-questioning__field"
                        >
                          <label
                      ...
                      <div className="questionnaire__score-screen">
                        <div className="score__ctas">
                          ...
                          {isBookingButtonVisible && (
                            <a
                              href={bookingUrl}
                              className="btn score__btn score__btn--book"
                            >
                              <CalendarIcon />
                              {bookConsultationButtonText}
                            </a>
...
export const Head = ({ data, pageContext }) => {
  ...
  const content = data.page.frontmatter.content.find(
  ...
  return (
    <SEO
      ...
      data={seoData}
      pageType="page"
      otherLanguages={fullOtherLanguages}
    />
  )
}
