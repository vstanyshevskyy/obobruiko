    ...
    <footer className="footer-container">
      ...
      <div className="footer__extra-links">
        <ul className="footer__extra-links-list">
          <li>
            <button type="button" className="footer__preferences-button" onClick={onOpenConsentPreferences}>
              {consentPreferencesLabel}
            </button>
          </li>
          {
      ...
      <div className="copyright-row">
        ...
        <div className="copyright-text">
          <ReactMarkdown>{copyrightText}</ReactMarkdown>
        </div>
      </div>
    </footer>
  );
...
Footer.propTypes = {
  ...
  consentPreferencesLabel: PropTypes.string.isRequired,
  copyrightText: PropTypes.string.isRequired,
  links: PropTypes.arrayOf(PropTypes.shape({
    text: PropTypes.string.isRequired,
    url: PropTypes.string.isRequired
  })).isRequired,
  onOpenConsentPreferences: PropTypes.func.isRequired
};
