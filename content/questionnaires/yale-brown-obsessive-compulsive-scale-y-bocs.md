...
content:
  ...
  - path: /questionnaires/y-bocs
    ...
    description: >-
      ...
      :icon-PiClockCountdownThin: Час проходження: Лише 10 запитань, 3-5 хвилин


      :icon-PiChartBarThin: Результат: миттєвий


      :icon-PiExclamationMarkThin: Важливо 


      Це не медичний діагноз. Для точної оцінки зверніться до спеціаліста.
    bookConsultationButtonLink: https://cal.com/psychologist-olesia-bobruiko-iudrdc/50-min-consultation
---
