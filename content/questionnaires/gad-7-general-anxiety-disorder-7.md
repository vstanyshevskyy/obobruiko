  ...
  - fbDescription: Пройди науково валідований онлайн тест GAD-7 із 7 запитань, щоб
    ...
    results:
      - text: "Мінімальна тривога (0–4). Твій результат показує мінімальний рівень
        ...
        maxScore: 4
        subscale: default
      - text: "Легка тривога (5–9). Ваш результат показує легкий рівень тривоги. Це
          нормально, і багато людей відчувають подібне періодично. Рекомендації,
          які можуть допомогти: повторювати тест через 2 тижні, щоб відстежувати
          стан; практикувати техніки самодопомоги або працювати з фахівцем у
          форматі когнітивно-поведінкової терапії (КПТ); ознайомитися зі
          статтею: «Не переймайся!» або знайомство з генералізованим тривожним
          розладом. Це лише попередня оцінка. Для більш точного розуміння свого
          стану варто звернутися до фахівця з психічного здоров’я – психіатра,
          психолога чи психотерапевта. Також рекомендується виключити можливі
          фізіологічні причини тривоги (ЕКГ, ТТГ)."
        minScore: 5
        maxScore: 9
        subscale: default
      - text: "Помірна тривога (10–14). Ваш результат свідчить про помірний рівень
          тривоги. Це сигнал приділити трохи більше уваги своєму емоційному
          стану. Можливі кроки: когнітивно-поведінкова терапія, практики
          релаксації, при потребі — консультація щодо медикаментозного лікування
          з фахівцем. Цей результат не є діагнозом. Для повної оцінки стану і
          підтримки психологічного здоров’я зверніться до фахівця. Важливо також
          виключити медичні причини тривоги (наприклад, порушення ритму серця
          або щитоподібної залози)."
        minScore: 10
        maxScore: 14
        subscale: default
