  ...
  - fbDescription: Пройди науково валідований онлайн тест GAD-7 із 7 запитань, щоб
    ...
    results:
      ...
      - text: >-
          ...
          * **Практикувати техніки самодопомоги та релаксації**, зокрема:
        ...
        maxScore: 9
        subscale: default
      - text: "Помірна тривога (10–14). Твій результат свідчить про помірний рівень
          тривоги. Це сигнал приділити трохи більше уваги своєму психічному
          здоровʼю. Що можна зробити: когнітивно-поведінкова терапія, практична
          релаксація або консультація лікаря щодо можливого медикаментозного
          лікування. Це не діагноз. Для повної оцінки стану та підтримки свого
          психологічного здоров’я звернися до фахівця – психолога,
          психотерапевта чи психіатра. Також важливо виключити медичні причини
          тривоги (аритмії, порушення роботи щитоподібної залози тощо)."
        minScore: 10
        maxScore: 14
        subscale: default
