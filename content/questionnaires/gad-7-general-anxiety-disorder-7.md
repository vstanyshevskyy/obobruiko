  ...
  - fbDescription: Пройди науково валідований онлайн тест GAD-7 із 7 запитань, щоб
    ...
    results:
      ...
      - text: >-
          ...
          * *Стаття [«Не переймайся!» або знайомство з генералізованим тривожним розладом](https://www.bobruiko.com/articles/dont-worry-anxiety-disorder/)*, де простими словами пояснюється, що таке тривога, генералізований тривожний розлад і як собі допомогти
