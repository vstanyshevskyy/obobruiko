  ...
  - fbDescription: Пройди науково валідований онлайн тест GAD-7 із 7 запитань, щоб
    ...
    results:
      ...
      - text: >-
          ...
          * повторити тест через 2 тижні, щоб відстежувати свій стан

          * практикувати техніки самодопомоги, наприклад техніки релаксації

            * ["Сканування тіла"](https://www.youtube.com/watch?v=i9Y8GtrD-uw&list=PL6NyhmgKcG0ldumKjO98rdLqAhjNLy3TU) 
            * Прогресивна мʼязова релаксація за Джекобсоном
            * Дихальні вправи ("Дихання за квадратом")
          * працювати з фахівцем у методі когнітивно-поведінкової терапії (КПТ); 

          * ознайомитися зі статтею: «Не переймайся!» або знайомство з генералізованим тривожним розладом. 
