  ...
  - fbDescription: Пройди науково валідований онлайн тест GAD-7 із 7 запитань, щоб
    ...
    results:
      ...
      - text: >-
        ...
        maxScore: 14
        subscale: default
      - text: "Важка тривога (15–21). Твій результат свідчить про високий рівень
          тривоги. Це означає, що тривога може суттєво впливати на твоє життя.
          Рекомендації: поєднання психотерапії (КПТ або прикладна релаксація) та
          медикаментозного лікування, якщо його призначає психіатр; обов’язково
          звернися до фахівця з психічного здоров’я – психолога, психотерапевта
          або психіатра – для детальної діагностики та підтримки. Пам’ятай:
          результат тесту – попередня оцінка, а не остаточний діагноз. Також
          важливо виключити можливі фізичні причини тривоги (наприклад, ЕКГ для
          аритмій, ТТГ для захворювань щитовидної залози)."
        minScore: 15
        maxScore: 21
        subscale: default
