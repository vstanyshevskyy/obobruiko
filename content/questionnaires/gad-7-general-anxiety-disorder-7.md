...
content:
  ...
  - fbDescription: Пройди науково валідований онлайн тест GAD-7 із 7 запитань, щоб
      ...
      - text: 8. Наскільки важко Вам було працювати, займатись домашніми справами або
        ...
        answers:
          ...
          - text: Надзвичайно важко
            value: 0
    instruction: >-
      1. Дай відповіді на 7 запитань про частоту симптомів тривожності за
      останні два тижні.

      2. Кожне питання має варіанти відповіді: «Зовсім ні», «Декілька днів», «Більше половини днів», «Майже щодня».

      3. Після завершення система підраховує бали та показує рівень тривожності.

      4. Отримай персональні рекомендації щодо подальших кроків.
    ...
    results:
      - text: >-
          **Мінімальна тривога (0–4 балів за шкалою GAD-7)** 


          Твій результат вказує на мінімальний рівень тривоги. Це означає, що симптоми тривожності або відсутні, або майже не впливають на твоє повсякденне життя, роботу та стосунки. На цьому етапі **спеціальне лікування чи психологічні втручання зазвичай не потрібні**.


          Важливо пам’ятати: **результат тесту GAD-7 є попередньою оцінкою**, **а не діагнозом**. Якщо ти відчуваєш внутрішню напругу, непевність або помічаєш, що тривога все ж періодично турбує, варто прислухатися до себе. За потреби ти завжди можеш звернутися до **фахівця з психічного здоровʼя** – психолога, психотерапевта або психіатра – щоб отримати професійну підтримку та рекомендації.
        minScore: 0
        maxScore: 4
        subscale: default
      - text: >-
          **Легка тривога (5–9 балів за шкалою GAD-7)**


          Твій результат вказує на легкий рівень тривоги. Це поширений стан – багато людей відчувають подібне час від часу, особливо в періоди стресу або підвищеного навантаження.


          **Що може допомогти на цьому етапі:**


          * **Краще зрозуміти свою тривогу** – почитати статтю [«Не переймайся!» або знайомство з генералізованим тривожним розладом](https://www.bobruiko.com/articles/dont-worry-anxiety-disorder/), де простими словами пояснюється, що таке тривога, генералізований тривожний розлад і як собі допомогти, або ознайомитися з іншими матеріалами про тривогу

          * **Повторити тест GAD-7 через 2 тижні**, щоб відстежити зміни стану

          * **Практикувати техніки релаксації**, зокрема:

            * *[Сканування тіла](https://www.youtube.com/watch?v=i9Y8GtrD-uw&list=PL6NyhmgKcG0ldumKjO98rdLqAhjNLy3TU) –* усвідомлене спостереження за тілесними відчуттями
          ...
          * **Працювати з фахівцем з психічного здоровʼя**, зокрема у методі когнітивно-поведінкової терапії (КПТ) 


          Важливо пам’ятати: **результат тесту GAD-7 є попередньою оцінкою, а не діагнозом**. Для точнішої оцінки стану варто звернутися до психолога, психотерапевта або психіатра. Також рекомендується **виключити можливі фізіологічні причини тривоги**, зокрема порушення серцевого ритму (ЕКГ) або функції щитоподібної залози (ТТГ).
        minScore: 5
        maxScore: 9
        subscale: default
      - text: >-
          **Помірна тривога (10–14 балів за шкалою GAD-7)** 


          Твій результат свідчить про помірний рівень тривоги. Це сигнал приділити **більше уваги своєму психічному здоровʼю**, оскільки симптоми можуть почати помітно впливати на самопочуття, концентрацію або щоденну активність. 
        ...
        subscale: default
      - text: >-
          **Важка тривога (15–21 бал за шкалою GAD-7)** 


          Твій результат свідчить про високий рівень тривоги. Це означає, що тривога може **суттєво впливати на повсякденне життя, роботу та стосунки**.
          ...
          * **Краще зрозуміти свою тривогу** – почитати статтю [«Не переймайся!» або знайомство з генералізованим тривожним розладом](<>), де простими словами пояснюється, що таке тривога, генералізований тривожний розлад і як собі допомогти, або ознайомитися з іншими матеріалами про тривогу
          ...
          Рекомендації: поєднання психотерапії (КПТ або прикладна релаксація) та медикаментозного лікування, якщо його призначає психіатр; обов’язково звернися до фахівця з психічного здоров’я – психолога, психотерапевта або психіатра – для детальної діагностики та підтримки. Пам’ятай: результат тесту – попередня оцінка, а не остаточний діагноз. Також важливо виключити можливі фізичні причини тривоги (наприклад, ЕКГ для аритмій, ТТГ для захворювань щитовидної залози).
        minScore: 15
        maxScore: 21
        subscale: default
    ...
    title: Тест на тривогу GAD-7 онлайн – оцінка генералізованої тривожності
    language: UK
    ...
    useWhiteForNav: false
    description: >-
      Тривога трапляється у кожного, але інколи вона може стати надто сильною та
      заважати щоденному життю.


      Якщо ти помічаєш часті хвилювання, напруження або труднощі з концентрацією, **науково валідований онлайн тест GAD-7** допоможе швидко оцінити рівень твоєї генералізованої тривоги.


      **7 запитань – і ти дізнаєшся, чи є у тебе мінімальна, легка, помірна чи важка тривога.**


      Після проходження тесту ти отримаєш **персональні рекомендації**, як підтримати своє емоційне та психологічне здоров’я.
