    ...
    results:
      - text: >-
          ...
          * Застосовуйте техніки релаксації
          ...
          ⚠️ **Важливо пам’ятати:** **результат тесту GAD-7 є попередньою оцінкою**, **а не діагнозом**. Якщо ви відчуваєте внутрішню напругу, непевність або помічаєте, що тривога все ж періодично турбує, варто прислухатися до себе. За потреби ви завжди можете звернутися до **фахівця з психічного здоровʼя** – психолога, психотерапевта або психіатра – щоб отримати професійну підтримку та рекомендації.
        minScore: 0
        maxScore: 4
        subscale: default
      - text: >-
