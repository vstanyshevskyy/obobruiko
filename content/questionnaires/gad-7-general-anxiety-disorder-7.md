  ...
  - fbDescription: Пройди науково валідований онлайн тест GAD-7 із 7 запитань, щоб
    ...
    instruction: >-
      ...
      3. Після завершення тесту ви отримаєте:
         ...
         * **Оцінку вашого рівня тривожності** за шкалою GAD-7 (мінімальна → важка)
         * **Персональні рекомендації** щодо подальших дій

      **Важливо:** GAD-7 – інструмент скринінгу і не замінює медичну діагностику. Якщо ваш рівень тривожності високий або турбує, радимо звернутися до психолога, психотерапевта або психіатра.
    ...
    title: Тест для скринінгу тривожності (GAD-7) онлайн
    language: UK
